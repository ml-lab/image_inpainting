...
def get_total_loss(I_out, I_gt, bin_mask, fai_out, fai_gt, fai_comp, layers,
                   I_comp):
  ...
  all_loss = 6 * l_hole + l_valid + 0.05 * percept_loss + 120 * (
        style_loss_out + style_loss_comp) + 0.1 * tv_loss
